        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/events"
                className="px-6 py-3 bg-[#C9A84C] text-white font-semibold rounded-xl hover:bg-[#C9A84C]/90 transition-smooth"
              >
                View Events
              </Link>
              <Link
                to="/feedback"
                className="px-6 py-3 bg-white/20 text-white font-semibold rounded-xl hover:bg-white/30 transition-smooth backdrop-blur-sm"
              >
                Give Feedback
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <Link
              key={path}
              to={path}
              className="group p-6 rounded-2xl border border-gray-200 hover:border-[#1B3A6B]/30 hover:shadow-lg transition-smooth bg-white"
            >
